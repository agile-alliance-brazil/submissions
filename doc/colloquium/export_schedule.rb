...
ROOM_CAPACITY = {
  Track.find_by(title: 'tracks.general_interest.title') => 160,
  Track.find_by(title: 'tracks.management.title') => 170,
  Track.find_by(title: 'tracks.engineering.title') => 170,
  Track.find_by(title: 'tracks.experience_reports.title') => 160
}.freeze
