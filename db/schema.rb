...
ActiveRecord::Schema.define(version: 20160501022620) do
  ...
  create_table "conferences", force: :cascade do |t|
    ...
    t.string   "supported_languages",     limit: 255, default: "en,pt", null: false
  ...
  create_table "pages", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "language",      limit: 255, default: "pt",  null: false
