...
Conference.seed do |conference|
  ...
  conference.submissions_deadline = Time.zone.local(2012, 5, 27, 23, 59, 59)
  conference.review_deadline      = Time.zone.local(2012, 6, 17, 23, 59, 59)
  conference.author_notification  = Time.zone.local(2012, 7, 8, 23, 59, 59)
  conference.author_confirmation  = Time.zone.local(2012, 7, 22, 23, 59, 59)
end
