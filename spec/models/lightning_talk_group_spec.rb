...
describe LightningTalkGroup, type: :model do
  ...
  describe "#lightning_talks" do
    it "should fetch Lightning Talks from serialized info" do
      ...
      expect(lightning_talk_group.lightning_talks).to eq(lightning_talks)
    end
    ...
    it "should return empty if Lightning Talks not found" do
      ...
      expect(lightning_talk_group.lightning_talks).to be_empty
    end
    ...
    it "should only return Lightning Talks that exist" do
      ...
      expect(lightning_talk_group.lightning_talks).to eq([lightning_talk])
    end
  end
  ...
  describe "#author_names" do
    it "should return author's full name for sessions" do
      ...
      expect(lightning_talk_group.author_names).to eq("Some One, Some Two")
    end
    ...
    it "should return author name for guest session" do
      ...
      expect(lightning_talk_group.author_names).to eq("Some One")
    end
  end
end
