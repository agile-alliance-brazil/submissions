module CanCan
  ...
  module Ability
    ...
    #   end
    # 
    def can?(action, noun, *can_params)
      (@can_definitions || []).reverse.each do |base_behavior, defined_action, defined_noun, defined_block|
        ...
        if includes_action?(defined_actions, action) && includes_noun?(defined_nouns, noun)
          result = can_perform_action?(action, noun, defined_actions, defined_nouns, defined_block, can_params)
    ...
    def can_perform_action?(action, noun, defined_actions, defined_nouns, defined_block, can_params)
