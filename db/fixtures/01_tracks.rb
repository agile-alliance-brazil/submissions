...
Track.seed do |track|
  track.id = 27
  track.conference_id = 6
  track.title = 'tracks.2015_development_tests.title'
  track.description = 'tracks.2015_development_tests.description'
end

Track.seed do |track|
  track.id = 28
  track.conference_id = 6
  track.title = 'tracks.2015_management.title'
  track.description = 'tracks.2015_management.description'
end

Track.seed do |track|
  track.id = 29
  track.conference_id = 6
  track.title = 'tracks.2015_coaching_learning.title'
  track.description = 'tracks.2015_coaching_learning.description'
end
...
Track.seed do |track|
  track.id = 31
  track.conference_id = 6
  track.title = 'tracks.2015_innovation_entrepreneurship.title'
  track.description = 'tracks.2015_innovation_entrepreneurship.description'
end
