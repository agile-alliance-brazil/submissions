...
describe CommentsController do
  ...
  it "index action should redirect to session path" do
    ...
    response.should redirect_to(session_url(@comment.commentable, :anchor => 'comments'))
  end

  it "show action should redirect to edit path" do
    get :show, :session_id => @comment.commentable, :id => @comment.id
    response.should redirect_to(edit_session_comment_url(@comment.commentable, @comment))
  end
