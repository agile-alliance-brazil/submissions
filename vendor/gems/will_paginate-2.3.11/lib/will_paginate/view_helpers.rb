...
module WillPaginate
  ...
  class LinkRenderer
    ...
    def to_html
      ...
      links.unshift page_link_or_span(@collection.previous_page, 'disabled prev_page', I18n.t(@options[:previous_label], :default => '&laquo; Previous'))
      links.push    page_link_or_span(@collection.next_page,     'disabled next_page', I18n.t(@options[:next_label], :default => 'Next &raquo;'))
