...
class AddContentToConference < ActiveRecord::Migration
  def self.up
    ...
    if ab2011
      ...
      ab2011.submissions_open = Time.zone.local(2011, 2, 14)
      ab2011.submissions_deadline = Time.zone.local(2011, 3, 27)
      ab2011.review_deadline = Time.zone.local(2011, 4, 17)
      ab2011.author_notification = Time.zone.local(2011, 4, 30)
      ab2011.author_confirmation = Time.zone.local(2011, 6, 7)
      ab2011.save!
    end
  end
