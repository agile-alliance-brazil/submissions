...
Conference.seed do |conference|
  ...
  conference.call_for_papers           = Time.zone.local(2014, 4, 7)
  conference.submissions_open          = Time.zone.local(2014, 4, 14)
  conference.presubmissions_deadline   = nil# No pre review
  conference.prereview_deadline        = nil# No pre review
  conference.submissions_deadline      = Time.zone.local(2014, 5, 26, 23, 59, 59)
  conference.review_deadline           = Time.zone.local(2014, 6, 15, 23, 59, 59)
  conference.voting_deadline           = nil# No voting
  conference.author_notification       = Time.zone.local(2014, 7, 1, 23, 59, 59)
  conference.author_confirmation       = Time.zone.local(2014, 7, 10, 2, 59, 59)
end
