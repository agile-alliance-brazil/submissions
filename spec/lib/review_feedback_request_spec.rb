...
describe ReviewFeedbackRequester do
  before do
    ...
    @requester = described_class.new
  end

  it 'raises error if there are sessions not published' do
  ...
  context 'Sessions are all published' do
    ...
    it 'captures error when sending feedback request and move on' do
