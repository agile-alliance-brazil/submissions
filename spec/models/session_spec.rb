  ...
  context "validations" do
    ...
    context "track" do
      it "should match the conference" do
        ...
        session = FactoryGirl.build(:session, :track => FactoryGirl.create(:track, conference: conference))
    ...
    context "audience level" do
      it "should match the conference" do
        conference = FactoryGirl.create(:conference)
        session = FactoryGirl.build(:session, :audience_level => FactoryGirl.create(:audience_level, conference: conference))
        expect(session).to_not be_valid
    ...
    context "session type" do
      it "should match the conference" do
        conference = FactoryGirl.create(:conference)
        session = FactoryGirl.build(:session, :session_type => FactoryGirl.create(:session_type, conference: conference))
        expect(session).to_not be_valid
    ...
    context "for_reviewer / for_review_in" do
      ...
      context "preferences" do
        ...
        it "multiple preferences" do
          track = @conference.tracks.second
